...
define dso_local noalias noundef ptr @toString(i32 noundef %0) local_unnamed_addr #2 {
  ...
  %3 = tail call i32 (ptr, ptr, ...) @sprintf(ptr noundef nonnull dereferenceable(1) %2, ptr noundef nonnull dereferenceable(1) @.str.2, i32 noundef %0) #13
  ret ptr %2
}
...
define dso_local noundef ptr @string.cat(ptr noundef returned %0, ptr nocapture noundef readonly %1) local_unnamed_addr #7 {
  %3 = tail call ptr @strcat(ptr noundef nonnull dereferenceable(1) %0, ptr noundef nonnull dereferenceable(1) %1) #13
  ret ptr %0
}
...
define dso_local noalias noundef ptr @.builtin.malloc(i32 noundef %0) local_unnamed_addr #8 {
  %2 = tail call ptr @malloc(i32 noundef %0) #13
  ret ptr %2
}

; Function Attrs: mustprogress nofree nounwind willreturn memory(inaccessiblemem: readwrite)
define dso_local noalias noundef ptr @.builtin.calloc(i32 noundef %0) local_unnamed_addr #8 {
  %2 = tail call ptr @calloc(i32 noundef 1, i32 noundef %0) #13
  ret ptr %2
}

; Function Attrs: mustprogress nofree nounwind willreturn allockind("alloc,zeroed") allocsize(0,1) memory(inaccessiblemem: readwrite)
declare dso_local noalias noundef ptr @calloc(i32 noundef, i32 noundef) local_unnamed_addr #9

; Function Attrs: mustprogress nofree nounwind willreturn memory(write, argmem: none, inaccessiblemem: readwrite)
define dso_local noalias nonnull ptr @array.malloc(i32 noundef %0, i32 noundef %1) local_unnamed_addr #10 {
  %3 = mul nsw i32 %1, %0
  %4 = add nsw i32 %3, 4
...
13:                                               ; preds = %5
  ...
  %18 = tail call ptr @memcpy(ptr noundef nonnull %17, ptr noundef nonnull %2, i32 noundef %14) #12
  br label %27
...
19:                                               ; preds = %11, %19
  ...
  %24 = tail call ptr @array.copy(i32 noundef %0, i32 noundef %12, ptr noundef %23) #13
...
define dso_local noundef nonnull ptr @.builtin.boolToString(i1 noundef zeroext %0) local_unnamed_addr #11 {
